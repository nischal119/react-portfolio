...
const TECH_STACK = ["React/Next.js", "Express.js", "Node.js", "MongoDB"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/nischal119" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/nischal-dhungel-497473269/",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/nischal__dhungel/?__pwa=1",
  },
];
...
const Home = () => {
  ...
  // Lottie configuration for Coding.json
  const lottieOptions = {
    src: "/Coding.json",
    loop: true,
    autoplay: true,
